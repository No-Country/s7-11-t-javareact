...
const Card = ({image, service, paragraph }) => {
  ...
  return (
    <div className="flex flex-col max-w-[22rem] lg:w-full lg:h-full">
      <div
        className={`flex flex-col justify-center p-[2%] max-270px]:h-[9.5rem] lg:h-full lg:w-full lg:bg-transparent bg-gray-50 drop-shadow-md rounded-2xl text-center text-neutral-900`}
      >
